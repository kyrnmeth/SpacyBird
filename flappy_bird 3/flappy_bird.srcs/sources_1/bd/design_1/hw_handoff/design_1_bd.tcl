...
# module references:
# Debounce_Switch, Debounce_Switch, Debounce_Switch, Debounce_Switch, GAME_logic, VGA_pattern, VGA_timings
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set iBtnDOWN [ create_bd_port -dir I iBtnDOWN ]
  set iBtnENTER [ create_bd_port -dir I iBtnENTER ]
  set iBtnUP [ create_bd_port -dir I iBtnUP ]
  set iClk [ create_bd_port -dir I -type clk iClk ]
  set iRst [ create_bd_port -dir I iRst ]
  set iSwCollision [ create_bd_port -dir I iSwCollision ]
  ...
  set block_name GAME_logic
  set block_cell_name GAME_logic_0
  if { [catch {set GAME_logic_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $GAME_logic_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  connect_bd_net -net Debounce_Switch_0_o_Switch [get_bd_pins Debounce_Switch_0/o_Switch] [get_bd_pins GAME_logic_0/iBtnUP]
  connect_bd_net -net Debounce_Switch_1_o_Switch [get_bd_pins Debounce_Switch_1/o_Switch] [get_bd_pins GAME_logic_0/iBtnDOWN]
  connect_bd_net -net Debounce_Switch_2_o_Switch [get_bd_pins Debounce_Switch_2/o_Switch] [get_bd_pins GAME_logic_0/iSwCollision]
  connect_bd_net -net Debounce_Switch_3_o_Switch [get_bd_pins Debounce_Switch_3/o_Switch] [get_bd_pins GAME_logic_0/iBtnENTER]
  connect_bd_net -net GAME_logic_0_oBirdPos [get_bd_pins GAME_logic_0/oBirdPos] [get_bd_pins VGA_pattern_0/iBirdPos]
  connect_bd_net -net GAME_logic_0_oPipePos [get_bd_pins GAME_logic_0/oPipePos] [get_bd_pins VGA_pattern_0/iPipePos]
  connect_bd_net -net GAME_logic_0_oWindowsPos [get_bd_pins GAME_logic_0/oWindowsPos] [get_bd_pins VGA_pattern_0/iWindowsPos]
  ...
  connect_bd_net -net VGA_timings_0_oActive [get_bd_pins VGA_pattern_0/iActive] [get_bd_pins VGA_timings_0/oActive]
  ...
  connect_bd_net -net VGA_timings_0_oHS [get_bd_ports oHS] [get_bd_pins VGA_timings_0/oHS]
  connect_bd_net -net VGA_timings_0_oVS [get_bd_ports oVS] [get_bd_pins VGA_timings_0/oVS]
  connect_bd_net -net clk_in1_0_1 [get_bd_ports iClk] [get_bd_pins clk_wiz_0/clk_in1]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins Debounce_Switch_0/i_Clk] [get_bd_pins Debounce_Switch_1/i_Clk] [get_bd_pins Debounce_Switch_2/i_Clk] [get_bd_pins Debounce_Switch_3/i_Clk] [get_bd_pins GAME_logic_0/iClk] [get_bd_pins VGA_timings_0/iClk] [get_bd_pins clk_wiz_0/clk_out1]
  connect_bd_net -net iRst_0_1 [get_bd_ports iRst] [get_bd_pins GAME_logic_0/iRst] [get_bd_pins VGA_timings_0/iRst]
  connect_bd_net -net i_Switch_0_1 [get_bd_ports iBtnUP] [get_bd_pins Debounce_Switch_0/i_Switch]
  connect_bd_net -net i_Switch_0_2 [get_bd_ports iBtnDOWN] [get_bd_pins Debounce_Switch_1/i_Switch]
  connect_bd_net -net i_Switch_0_3 [get_bd_ports iSwCollision] [get_bd_pins Debounce_Switch_2/i_Switch]
  connect_bd_net -net i_Switch_0_4 [get_bd_ports iBtnENTER] [get_bd_pins Debounce_Switch_3/i_Switch]
