...
# module references:
# Debounce_Switch, Debounce_Switch, Debounce_Switch, GAME_logic, VGA_pattern, VGA_timings
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins Debounce_Switch_0/i_Clk] [get_bd_pins Debounce_Switch_1/i_Clk] [get_bd_pins Debounce_Switch_2/i_Clk] [get_bd_pins GAME_logic_0/iClk] [get_bd_pins VGA_timings_0/iClk] [get_bd_pins clk_wiz_0/clk_out1]
